...
//     // Create sale
//     // controllers/sale.controller.ts - Updated createSale method
...
//                 const taxRate = 0.05; // 5% tax - you can make this configurable
...
//             const receiptData = {
//                 orderId: result.id,
//                 items: result.saleItems.map(item => ({
...
//                     location: result.store.location,
//                     phone: result.store.phone
//                 },
//                 cashier: `${result.employee.user.firstName} ${result.employee.user.lastName}`,
...
//                 sale: result,
//                 receipt: receiptData,
//                 printData: receiptData // This will be used by the frontend for printing
//             });
